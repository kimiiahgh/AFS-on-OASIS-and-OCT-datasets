...
def show_result(ac_score_list,dataset_name):
    ...
    if dataset_name=='mnist_rc':
        plt.savefig('mnist_rc.png')   # save the figure to file
        plt.show()
    elif dataset_name=='mnist_mb':
        plt.savefig('mnist_mb.png')   # save the figure to file
        plt.show()
    elif dataset_name=='mnist_awgn':
        plt.savefig('mnist_awgn.png')   # save the figure to file
        plt.show()
    elif dataset_name=='OCT':
        plt.savefig('OCT.png')   # save the figure to file
        plt.show()
    elif dataset_name=='OASIS':
        plt.savefig('OASIS.png')   # save the figure to file
        plt.show()        
        
        
    #plt.savefig('plot3.png')   # save the figure to file
    #plt.show()
